...
## Project Structure
    ...
    ├── testapiautocatalog_115872  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_115872`
...
2. Clone this repo and `cd testapiautocatalog_115872`
